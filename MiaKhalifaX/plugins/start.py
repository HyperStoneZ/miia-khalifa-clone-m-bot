...
from MiaKhalifaX import Telegram, YouTube, app
from MiaKhalifaX.misc import SUDOERS, _boot_
from MiaKhalifaX.plugins.playlist import del_plist_msg
from MiaKhalifaX.plugins.sudoers import sudoers_list
from MiaKhalifaX.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from MiaKhalifaX.utils.decorators.language import LanguageStart
from MiaKhalifaX.utils.formatters import get_readable_time
from MiaKhalifaX.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/miiakhalifamusic_support) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="𝗦𝘂𝗽𝗽𝗼𝗿𝘁", url="https://t.me/miiakhalifamusic_support"
                        ),
                    ],
                ]
            )
